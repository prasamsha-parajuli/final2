...
<h2>Readmore...</h2>
<p>All the case studies about our products are available here!</p>
   
</section>
<section id="blog">
    <div class="blog-box">
        <div class="blog-img">
           <img src="Image/Aune collection 2.jpeg" alt="">
        </div>
    ...
    <div class="blog-box">
        <div class="blog-img">
           <img src="Image/_ (8).jpeg" alt="">
        </div>
        <div class="blog-details">
            <h4>Thrift for Sustainability</h4>
            <p>
                Triftnest champions sustainability by empowering our customers to make conscious choices with pre-loved items at
                 affordable prices. By opting for second-hand goods, our community helps to reduce clothing overconsumption, 
                 extending the life cycle of each garment and minimizing waste. This approach not only offers unique, high-quality
                  items to our customers but also promotes an eco-conscious lifestyle, aiming to decrease the environmental 
                  footprint of the fashion industry. 
                Together, we create a positive impact on the planet—one item at a time.</p>
              <!-- <a href="#" >See more</a> -->
